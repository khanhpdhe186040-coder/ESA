  ...
  return (
    ...
    >
      ...
      {unreadCount > 0 && !isOpen && (
        <span className="absolute -top-1 -right-1 inline-flex items-center justify-center px-1.5 min-w-[20px] h-5 text-xs font-bold leading-none text-white bg-red-600 rounded-full">
